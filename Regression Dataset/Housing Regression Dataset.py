...
df.plot.scatter(x='latitude', y='longitude', title='Scatter Plot of latitude and longitude percentages');
plt.show()
...
def calc(slope, intercept, longitude):
    return slope*longitude+intercept
...
variables = ['longitude', 'housing_median_age', 'total_rooms', 'total_bedrooms', 
             'population', 'households', 'median_income', 'median_house_value']

for var in variables:
    plt.figure(figsize=(6,4))
    sns.regplot(x=var, y='latitude', data=df)
    plt.title(f'Regression plot of {var} and latitude') # f lagana zaroori
    plt.show()
